    ...
    <footer className="border-t border-t-gray-200 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <h2 className='text-2xl font-bold'>Next<span className='text-[#F83002]'>Hire</span ><span className='text-[#32CD32] font-bold'>Hub</span></h2>
            <p className="text-sm font-bold">© 2024 Nitesh Kumar Sah. All rights reserved.</p>
          </div>
